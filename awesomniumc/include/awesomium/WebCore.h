...
/**
 * @mainpage Awesomium API
 *
 * @section intro_sec Introduction
 *
 * Hi there, welcome to the Awesomium API docs! Awesomium is a software 
 ...
 * - Awesomium Main: <http://www.khrona.com/products/awesomium>
 * - Support Home: <http://support.awesomium.com>
 * 
 * @section copyright_sec Copyright
 * This documentation is copyright (C) 2010 Khrona. All rights reserved. 
